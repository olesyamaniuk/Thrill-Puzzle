document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".q-v-navigation-list");
  const headerRef = document.querySelector(".q-v-header");
  const navigationRef = document.querySelector(".q-v-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".q-v-toggle-button img");
